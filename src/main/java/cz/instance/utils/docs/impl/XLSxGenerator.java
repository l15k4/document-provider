...
public class XLSxGenerator extends DocumentGenerator {

	@Override
	protected void populate(File file, String content) throws Exception {
		createXLSxDocument(content, file);
	}

	@Override
	protected void populateSample(File sampleFile, String sample) throws Exception {
		createXLSxDocument(sample, sampleFile);
	}

	private void createXLSxDocument(String from, File file) throws Exception {
